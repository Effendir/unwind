...
function mail_form () {
  ...
  const form = '<form id="contact-form"><input type="hidden" name="contact_number"><label>Name</label><br><input type="text" name="user_name"><br><label>Email</label><br><input type="email" name="user_email"><br><label>Message</label><br><textarea name="message"></textarea><br><input id="send-button" type="submit" value="Send"><br></form>';
